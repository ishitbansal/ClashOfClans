...
def printMap(V):
    ...
    for stealth_arch in stealth_archers:
        ...
        if (time.time()-stealth_arch.spawn_time < 10):
            map_matrix[a][b] = stealth_archColor(
                stealth_arch) + Fore.WHITE + 'ST'
            map_matrix[a +
                       1][b] = stealth_archColor(stealth_arch) + Fore.WHITE + 'CH'
            map_matrix[a][b +
                          1] = stealth_archColor(stealth_arch) + Fore.WHITE + 'AR'
            map_matrix[a+1][b +
                            1] = stealth_archColor(stealth_arch) + Fore.WHITE + 'ER'
        else:
            map_matrix[a][b] = stealth_archColor(
                stealth_arch) + Fore.BLACK + 'ST'
            map_matrix[a +
                       1][b] = stealth_archColor(stealth_arch) + Fore.BLACK + 'CH'
            map_matrix[a][b +
                          1] = stealth_archColor(stealth_arch) + Fore.BLACK + 'AR'
            map_matrix[a+1][b +
                            1] = stealth_archColor(stealth_arch) + Fore.BLACK + 'ER'
